<?php
  ...
  if (array_key_exists("id", $_SESSION) ) {
    ...
    $query = "SELECT id, collegeID FROM `users` WHERE id = ".mysqli_real_escape_string($conn, $_SESSION['id'])." LIMIT 1";
   ...
   $mainBody = '';
   $count = 0;
   $query = "SELECT * FROM `issue` WHERE userID = '".mysqli_real_escape_string($conn, $row['id'])."'";
   ...
   if($result){
       if(mysqli_num_rows($result)>0){
           while($row1 = mysqli_fetch_assoc($result)){
             if($row1['tag'] == "1"){
                 ...
                 $state = "returned";
                 $row1["issueDate"] = $row1["returnDate"];
             }
             else{
                 $state = "-";
             }
    ...
    //   $query = "SELECT `tag` FROM `issue` WHERE id = '".mysqli_real_escape_string($conn, $_POST['id'])."'";
    //   $result = mysqli_query($conn, $query);
      ...
      <div class="col-md-7 py-2">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb remalign">
            ...
            <li class="breadcrumb-item"><a href="./student.php">admin</a></li>
            <li class="breadcrumb-item">issues-requests</li>
          </ol>
        </nav>
      </div>
    ...
    <div class="row main-content border border-top-0">
      ...
      <ul class="nav flex-column">
          ...
          <li class="nav-item bg-primary rounded">
            <a class="nav-link disabled text-light">Issue Requests</a>
          </li>
          <li class="nav-item">
