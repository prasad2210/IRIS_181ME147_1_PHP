<?php
  ...
  if (array_key_exists("id", $_SESSION) ) {
   ...
   $mainBody = '';
   $count = 0;
   $query = "SELECT id, userID, bookID, tag, issueDate FROM `issue`";
   $result = mysqli_query($conn, $query);
   if($result){
       if(mysqli_num_rows($result)>0){
           while($row1 = mysqli_fetch_assoc($result)){
             if($row1['tag'] == "-1" or $row1['tag'] == "2"){
               $count++;
      ...
      <div class="col-md-7 py-2">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb remalign">
            ...
            <li class="breadcrumb-item">issues-rejected</li>
          </ol>
        </nav>
      </div>
          ...
          <li class="nav-item">
            ...
            <!-- <div id="submenu" class="collapse"> -->
              <ul>
                ...
                <li><a href="javascript:void(0)" disabled>Rejected</a></li>
              </ul>
            <!-- </div> -->
          </li>
          <li class="nav-item">
